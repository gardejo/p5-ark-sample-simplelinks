...
is_deeply( [$site_a->tag_ids], [$tag_a->id],
           '$site_a->tag_ids [a] ok' );
is_deeply( [$site_b->tag_ids], [$tag_a->id, $tag_b->id],
           '$site_b->tag_ids [a,b] ok' );
is_deeply( [$site_c->tag_ids], [$tag_b->id],
           '$site_c->tag_ids [b] ok' );
is_deeply( [$site_d->tag_ids], [$tag_c->id],
           '$site_d->tag_ids [c] ok' );
...
is_deeply( [map { $_->id } $site_a->tags], [$tag_a->id],
           '$site_a->tags [a] ok' );
is_deeply( [map { $_->id } $site_b->tags], [$tag_a->id, $tag_b->id],
           '$site_b->tags [a,b] ok' );
is_deeply( [map { $_->id } $site_c->tags], [$tag_b->id],
           '$site_c->tags [b] ok' );
is_deeply( [map { $_->id } $site_d->tags], [$tag_c->id],
           '$site_d->tags [c] ok' );
...
is_deeply( [$tag_b->website_ids], [$site_b->id, $site_c->id],
           '$tag_b->website_ids [b,c] ok' );
is_deeply( [$tag_c->website_ids], [$site_d->id],
...
is_deeply( [map { $_->id } $tag_b->websites], [$site_b->id, $site_c->id],
           '$tag_b->websites [b,c] ok' );
is_deeply( [map { $_->id } $tag_c->websites], [$site_d->id],
           '$tag_c->websites [d] ok' );
...
# 明示的なキャッシュ更新メソッドを叩くより、$tag->reloadした方がよい。
is( $tag_a->count_websites, 0, '$tag_a->count_websites [0] [2] ok' );
is( $tag_b->count_websites, 0, '$tag_b->count_websites [0] [2] ok' );
is( $tag_c->count_websites, 0, '$tag_c->count_websites [0] [1] ok' );
...
is( $tag_b->count_current_websites, 2, '$tag_b->count_websites [2]<[2] ok' );
is( $tag_c->count_current_websites, 1, '$tag_c->count_websites [1]<[1] ok' );
...
is( $tag_b->count_websites, 2, '$tag_b->count_websites [2] [2] ok' );
is( $tag_c->count_websites, 1, '$tag_c->count_websites [1] [1] ok' );
is( $tag_d->count_websites, 0, '$tag_d->count_websites [0] [0] ok' );
